...
import static com.example.crypto.RecipeDetailActivity.coinIndex;
...
public class FetchPrice extends AsyncTask<String, Void, String> {
    ...
    protected void onPostExecute(String s) {
        ...
        try {
            ...
            JSONObject priceObj = itemsArray.getJSONObject(coinIndex); //----------HERE IS WHERE YOU CHANGE THE INDEX PLACE TO MATCH THE LOCATION OF EACH CRYPTO IN THE API ARRAY
            //get PriceUSD key
